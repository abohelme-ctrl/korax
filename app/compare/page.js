...
const ALL_TEAMS = [
  // Group A
  { id: '16',   name: 'المكسيك',           flag: '🇲🇽', group: 'A', stars: 0, titles: 0, bestResult: 'ربع النهائي',          confederation: 'كونكاكاف',        coach: 'خافيير أغيري',       rating: 78, players: ['ساندياغو خيمينيز', 'إيدسون ألفاريز', 'رائول خيمينيز'] },
  { id: '1531', name: 'جنوب أفريقيا',      flag: '🇿🇦', group: 'A', stars: 0, titles: 0, bestResult: 'الدور الأول',          confederation: 'كاف',             coach: 'هيوغو برووس',        rating: 65, players: ['رونجين وليامز', 'ثيمبا زوان', 'ريليندو موفوكينغ'] },
  { id: '149',  name: 'كوريا الجنوبية',    flag: '🇰🇷', group: 'A', stars: 0, titles: 0, bestResult: 'نصف النهائي 2002',     confederation: 'الاتحاد الآسيوي', coach: 'هونغ ميونغ-بو',     rating: 76, players: ['سون هيونغ-مين', 'لي كانغ-إن', 'كيم مين-جاي'] },
  ...
  // Group B
  { id: '101',  name: 'كندا',              flag: '🇨🇦', group: 'B', stars: 0, titles: 0, bestResult: 'الدور الأول',          confederation: 'كونكاكاف',        coach: 'جيسي مارش',          rating: 75, players: ['ألفونسو ديفيز', 'جوناثان ديفيد', 'تافاري بوكاناي'] },
  { id: '776',  name: 'البوسنة والهرسك',   flag: '🇧🇦', group: 'B', stars: 0, titles: 0, bestResult: 'الدور الأول 2014',    confederation: 'يويفا',            coach: 'سيرجي باربارز',      rating: 70, players: ['إدين دزيكو', 'إيرمين ديميروفيتش', 'ساد كولاشيناك'] },
  ...
  { id: '15',   name: 'سويسرا',            flag: '🇨🇭', group: 'B', stars: 0, titles: 0, bestResult: 'ربع النهائي',          confederation: 'يويفا',            coach: 'مورات ياكين',        rating: 77, players: ['غرانيت جاكا', 'مانويل أكانجي', 'برييل إمبولو'] },
  // Group C
  ...
  { id: '32',   name: 'المغرب',            flag: '🇲🇦', group: 'C', stars: 0, titles: 0, bestResult: 'نصف النهائي 2022',    confederation: 'كاف',             coach: 'وليد الركراكي',      rating: 78, players: ['أشرف حكيمي', 'براهيم دياز', 'عزيز الدين أوناحي'] },
  { id: '507',  name: 'هايتي',             flag: '🇭🇹', group: 'C', stars: 0, titles: 0, bestResult: 'الدور الأول',          confederation: 'كونكاكاف',        coach: 'مارك كوكيني',        rating: 60, players: ['دكينز نازون', 'وانيو إيسيدور', 'ريتشارد بروفيدانس'] },
  ...
  // Group D
  { id: '779',  name: 'باراغواي',          flag: '🇵🇾', group: 'D', stars: 0, titles: 0, bestResult: 'ربع النهائي 2010',    confederation: 'كونميبول',        coach: 'غوستافو كوسيتاس',    rating: 69, players: ['ميغيل ألميرون', 'خوليو إنسيسو', 'أنطونيو سانابريا'] },
  ...
  { id: '1532', name: 'كوراساو',           flag: '🇨🇼', group: 'E', stars: 0, titles: 0, bestResult: 'أول مشاركة',           confederation: 'كونكاكاف',        coach: 'رياو',               rating: 58, players: ['ليانو باكونا', 'تيل نوسلين', 'جيريمي لوكاديا'] },
  { id: '31',   name: 'ساحل العاج',        flag: '🇨🇮', group: 'E', stars: 0, titles: 0, bestResult: 'الدور الأول',          confederation: 'كاف',             coach: 'إيمريك لابورت',      rating: 73, players: ['سيمون عدينغرا', 'فرانك كيسي', 'إيلي واهي'] },
  { id: '57',   name: 'بوليفيا',           flag: '🇧🇴', group: 'E', stars: 0, titles: 0, bestResult: 'الدور الأول',          confederation: 'كونميبول',        coach: 'أنطونيو كارلوس سيما', rating: 61, players: ['مارسيلو مورينو', 'رودريغو راميرو', 'فرناندو سوسا'] },
  // Group F
  ...
  { id: '744',  name: 'السويد',            flag: '🇸🇪', group: 'F', stars: 0, titles: 0, bestResult: 'نصف النهائي',          confederation: 'يويفا',            coach: 'يون دال توماسون',    rating: 74, players: ['ألكساندر إيزاك', 'فيكتور غيوكيريس', 'أنتوني إيلانغا'] },
  { id: '4601', name: 'تونس',              flag: '🇹🇳', group: 'F', stars: 0, titles: 0, bestResult: 'الدور الأول',          confederation: 'كاف',             coach: 'جلال القادري',       rating: 68, players: ['هانيبال ميجبري', 'إيسام الخيري', 'أنيس بن سليمان'] },
  // Group G
  ...
  // Group H
  { id: '9',    name: 'إسبانيا',           flag: '🇪🇸', group: 'H', stars: 1, titles: 1, bestResult: 'بطل (2010)',            confederation: 'يويفا',            coach: 'لويس دي لا فوينتي',  rating: 87, players: ['لامين يامال', 'بيدري', 'نيكو وليامز'] },
  ...
  { id: '2',    name: 'فرنسا',             flag: '🇫🇷', group: 'I', stars: 2, titles: 2, bestResult: 'بطل (مرتان)',          confederation: 'يويفا',            coach: 'ديديه ديشان',        rating: 89, players: ['كيليان مبابي', 'أوريليان تشوامني', 'مارك ثيرام'] },
  ...
  { id: '141',  name: 'السعودية',          flag: '🇸🇦', group: 'J', stars: 0, titles: 0, bestResult: 'دور الـ16',            confederation: 'الاتحاد الآسيوي', coach: 'هيرفي رونار',        rating: 71, players: ['سالم الدوسري', 'محمد العواجي', 'سعود عبد الحميد'] },
  { id: '60',   name: 'الإكوادور',         flag: '🇪🇨', group: 'J', stars: 0, titles: 0, bestResult: 'دور الـ16 2006',       confederation: 'كونميبول',        coach: 'ليون كاو',           rating: 71, players: ['موسيس كايسيدو', 'إنير فالنسيا', 'بييرو إنكابييه'] },
  ...
  // Group L
  { id: '36',   name: 'مصر',               flag: '🇪🇬', group: 'L', stars: 0, titles: 0, bestResult: 'الدور الأول',          confederation: 'كاف',             coach: 'هيرتسوغ',            rating: 73, players: ['محمد صلاح', 'عمر مرموش', 'تريزيغيه'] },
  { id: '33',   name: 'السنغال',           flag: '🇸🇳', group: 'L', stars: 0, titles: 0, bestResult: 'نصف النهائي 2002',    confederation: 'كاف',             coach: 'عليو سيسيه',         rating: 75, players: ['صاديو ماني', 'إسماعيلا سار', 'نيكولاس جاكسون'] },
  { id: '96',   name: 'الجزائر',           flag: '🇩🇿', group: 'L', stars: 0, titles: 0, bestResult: 'دور الـ16 2014',       confederation: 'كاف',             coach: 'دجامل بلماضي',       rating: 74, players: ['رياض محرز', 'محمد عمورة', 'أمين غويري'] },
  { id: '48',   name: 'بلجيكا',            flag: '🇧🇪', group: 'L', stars: 0, titles: 0, bestResult: 'المركز الثالث 2018',  confederation: 'يويفا',            coach: 'دومينيكو تيدسكو',    rating: 82, players: ['كيفن دي بروين', 'روميلو لوكاكو', 'جيريمي دوكو'] },
]
